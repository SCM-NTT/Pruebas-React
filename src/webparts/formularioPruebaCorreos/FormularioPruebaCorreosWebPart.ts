...
import * as strings from 'FormularioPruebaCorreosWebPartStrings';
import useFormularioPruebaCorreos from './components/FormularioPruebaCorreos';
...
export default class FormularioPruebaCorreosWebPart extends BaseClientSideWebPart<IFormularioPruebaCorreosWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IFormularioPruebaCorreosProps> = React.createElement(
      useFormularioPruebaCorreos,
      {
